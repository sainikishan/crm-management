            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('countries.update',$data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="capital" type="text" class="form-control @error('capital') is-invalid @enderror" name="capital" value="{{ $data['capital'] }}" autocomplete="capital">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="currency" type="text" class="form-control @error('currency') is-invalid @enderror" name="currency" value="{{ $data['currency'] }}" autocomplete="currency">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="shortcode" type="text" class="form-control @error('shortcode') is-invalid @enderror" name="shortcode" value="{{ $data['short_code'] }}" autocomplete="shortcode">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="callingcode" type="text" class="form-control @error('callingcode') is-invalid @enderror" name="callingcode" value="{{ $data['calling_code'] }}" autocomplete="callingcode">
