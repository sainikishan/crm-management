    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                        <form method="POST" action="{{route('zipcodes.store') }}" enctype="multipart/form-data">
                            @csrf
...
<option  class="from-control" value="{{ $company->id}}">{{$company->name}}</option>
                      @endforeach
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="streetname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="streetname" value="{{ old('streetname') }}"  autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="streetnumber" type="text" class="form-control @error('lastname') is-invalid @enderror" name="streetnumber" value="{{ old('streetnumber') }}"  autocomplete="name" autofocus>
